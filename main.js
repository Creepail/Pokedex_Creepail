...
function FindingAutocomplete(x){
    ...
    console.log(validname)
        if(typeof validname[2] === 'undefined'){
            searchbar.innerHTML= '<div class="autocomplete search_width">' + '<p>' +validname[0].charAt(0).toUpperCase() + validname[0].slice(1)+ '</p>' + '</div>'
        } 
        else if(typeof validname[3] === 'undefined') {
            searchbar.innerHTML= '<div class="autocomplete search_width">' + '<p>' +validname[0].charAt(0).toUpperCase() + validname[0].slice(1)+ '</p>'+ '</div> <div class="autocomplete search_width">' + '<p>' +validname[1].charAt(0).toUpperCase() + validname[1].slice(1)+ '</p>'+ '</div>'
        }

        else {
            searchbar.innerHTML= '<div class="autocomplete search_width">' + '<p>' +validname[0].charAt(0).toUpperCase() + validname[0].slice(1)+ '</p>'+ '</div> <div class="autocomplete search_width">' + '<p>' +validname[1].charAt(0).toUpperCase() + validname[1].slice(1)+ '</p>'+ '</div> <div class="autocomplete search_width">' + '<p>' +validname[2].charAt(0).toUpperCase() + validname[2].slice(1)+ '</p>'+ '</div>'
